function autoWidthSelfTsest() {
    var a = 680, b = $("html").width();
    a >= b ? ($(".tab_item-man").not(":first").show(), $(".tab_item-she").not(":first").show(), $(".tab_item-baby").not(":first").show()) : ($(".tab_item-man").not(":first").hide(), $(".wrapper-man .tab-man").show().click(function () {
        var a = $(this).index();
        $(".tab_item-man").hide().eq(a).fadeIn()
    }), $(".tab_item-she").not(":first").hide(), $(".wrapper-she .tab-she").show().click(function () {
        var a = $(this).index();
        $(".wrapper-she .tab-she").removeClass("active-she").eq(a).addClass("active-she"), $(".tab_item-she").hide().eq(a).fadeIn()
    }).eq(0).addClass("active-she"), $(".tab_item-baby").not(":first").hide(), $(".wrapper-baby .tab-baby").show().click(function () {
        var a = $(this).index();
        $(".wrapper-baby .tab-baby").removeClass("active-baby").eq(a).addClass("active-baby"), $(".tab_item-baby").hide().eq(a).fadeIn()
    }).eq(0).addClass("active-baby"))
}
function autoWidthSymptom() {
    var a = 925, b = $("html").width();
    a >= b ? ($(".tab_item-neck").not(":first").show(), $(".tab_item-chest").not(":first").show(), $(".tab_item-small-pelvis").not(":first").show()) : ($(".tab_item-neck").not(":first").hide(), $(".tab_item-chest").not(":first").hide(), $(".tab_item-small-pelvis").not(":first").hide(), $(".wrapper-neck .tab-neck").show().click(function () {
        var a = $(this).index();
        $(".tab_item-neck").hide().eq(a).fadeIn()
    }), $(".wrapper-chest .tab-chest").show().click(function () {
        var a = $(this).index();
        $(".tab_item-chest").hide().eq(a).fadeIn()
    }), $(".wrapper-small-pelvis .tab-small-pelvis").show().click(function () {
        var a = $(this).index();
        $(".tab_item-small-pelvis").hide().eq(a).fadeIn()
    }))
}
/*function autoWidth() {
    var a = 1200, b = $("html").width();
    a >= b ? $(".article").addClass("swiper-container") : $(".article").removeClass("swiper-container", "swiper-container-horizontal")
}*/
(function () {
    ...
    $(".reason").ready(function () {
        var a = $(this).find(".reason__list").innerHeight();
        $(this).find(".reason__img-left").css("height", a + 15), console.log(a);
        var b = $(this).find(".js-reason-p-h").innerHeight();
        $(this).find(".reason__img-left").css("top", b)
    }), $(".doctor").ready(function () {
        var a = $(this).find("div.doctor img").innerWidth(), b = $(this).find("div.left-side").innerWidth(), c = b - a - 30;
        $(this).find("div.doctor div.doctor__list-item").css("width", c)
    }), $(".reason--note").ready(function () {
        var a = $(this).find("div.reason--note img").innerWidth(), b = $(this).find("div.left-side").innerWidth(), c = b - a - 130;
        $(this).find("div.reason--note div.reason__list--left").css("width", c)
    })
}), function (a) {
    var b = {}, c = {
        mode: "horizontal",
    ...
    a.fn.bxSlider = function (d) {
        ...
        var g = a(window).width(), h = a(window).height(), j = function () {
            ...
            var a = 0;
            if (e.settings.moveSlides > 0)if (e.settings.infiniteLoop)a = Math.ceil(e.children.length / s()); else for (var b = 0, c = 0; b < e.children.length;)++a, b = c + q(), c += e.settings.moveSlides <= q() ? e.settings.moveSlides : q(); else a = Math.ceil(e.children.length / q());
            return a
        }, s = function () {
            ...
            e.settings.auto && f.stopAuto(), f.goToNextSlide(), b.preventDefault(), a(".st-bxslider__wrap").removeClass("move", 500), a(".st-pic__item").removeClass("active"), a(".st-list").fadeOut(100)
        }, B = function (b) {
            e.settings.auto && f.stopAuto(), f.goToPrevSlide(), b.preventDefault(), a(".st-bxslider__wrap").removeClass("move", 500), a(".st-pic__item").removeClass("active"), a(".st-list").fadeOut(100)
        }, C = function (a) {
    ...
    a.rating = function (b, c) {
        ...
        }, c || {}), this.el = a(b), this.left = 0, this.width = 0, this.height = 0, this._data = {};
        var d = this;
        this.el.find(":hidden").each(function () {
            var b = a(this);
            d._data[b.attr("name")] = b.val()
        }), this._data.val = parseFloat(this._data.val) || 0, this._data.votes = parseFloat(this._data.votes) || "", this._data.val > this.options.stars && (this._data.val = this.options.stars), this._data.val < 0 && (this._data.val = 0), this.old = this._data.val, this.vote_wrap = a('<div class="vote-wrap"></div>'), this.vote_block = a('<div class="vote-block"></div>'), this.vote_hover = a('<div class="vote-hover"></div>'), this.vote_stars = a('<div class="vote-stars"></div>'), this.vote_active = a('<div class="vote-active"></div>'), this.vote_result = a('<div class="vote-result"></div>'), this.vote_success = a('<div class="vote-success"></div>'), this.loader = a('<img src="' + this.options.loader + '" alt="load...">'), this.el.html(this.loader);
        var e = new Image;
        e.src = this.options.image, e.onload = function () {
            d.width = this.width, d.height = this.height / 3, d.init()
        }
    };
    var b = a.rating;
    b.fn = b.prototype = {rating: "2.0"}, b.fn.extend = b.extend = a.extend, b.fn.extend({
        init: function () {
            if (this.render(), !this.options.readOnly) {
                ...
                this.vote_hover.bind("mousemove mouseover", function (e) {
                    if (!b.options.readOnly) {
                        ...
                        var h = b.width * b.options.stars, i = b.options.minimal * b.width;
                        d > h && (d = h), i > d && (d = i), g = Math.round(d / b.width * 10) / 10, "half" == b.options.fx ? d = Math.ceil(d / b.width * 2) * b.width / 2 : "float" != b.options.fx && (d = Math.ceil(d / b.width) * b.width), g = Math.round(d / b.width * 10) / 10, b.vote_active.css({
                            width: d,
                    ...
                    if (!b.options.readOnly) {
                        var a = Math.round(d / b.width * 10) / 10;
                        a > b.options.stars && (a = b.options.stars), 0 > a && (a = 0), b.old = b._data.val, b._data.val = (b._data.val * b._data.votes + a) / (b._data.votes + 1), b._data.val = Math.round(100 * b._data.val) / 100, b._data.score = a, b.vote_success.html("Ваша оценка: " + a), "" != b.options.url && b.send(), b.options.readOnly = !0, b.options.click.apply(this, [a])
                    }
                })
            }
        }, set: function () {
            ...
            var c = this;
            this.vote_result.html(this.loader), this._data.votes++, a.ajax({
                url: c.options.url,
                type: c.options.type,
                data: this._data,
                dataType: "json",
                success: function (a) {
                    "OK" == a.status ? c.set() : (c._data.votes--, c.reset()), c.setvoters(), a.msg && c.vote_success.html(a.msg), "function" == typeof c.options.callback && c.options.callback.apply(c, [a])
                }
            })
        ...
        if ("string" == typeof c) {
            var d = a(this).data("rating"), e = Array.prototype.slice.call(arguments, 1);
    ...
    a.extend(a.fn, {
        ...
        prototype: {
            init: function () {
                ...
                return this.checkForm(), a.extend(this.submitted, this.errorMap), this.invalid = a.extend({}, this.errorMap), this.valid() || a(this.currentForm).triggerHandler("invalid-form", [this]), this.showErrors(),
                    this.valid()
            }, checkForm: function () {
                this.prepareForm();
    ...
    function ga(a, b, c) {
        ...
        if (!this._monthsParse)for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], d = 0; 12 > d; ++d)f = j([2e3, d]), this._shortMonthsParse[d] = this.monthsShort(f, "").toLocaleLowerCase(), this._longMonthsParse[d] = this.months(f, "").toLocaleLowerCase();
    ...
    function ia(a, b) {
        ...
        if ("string" == typeof b)if (/^\d+$/.test(b))b = t(b); else if (b = a.localeData().monthsParse(b), "number" != typeof b)return a;
    ...
    function _a(a, b) {
        ...
        } else null != uf[a] && (null != uf[a].parentLocale ? uf[a] = uf[a].parentLocale : null != uf[a] && delete uf[a]);
        return uf[a]
    }
    ...
    }), T("e", 0, 0, "weekday"), T("E", 0, 0, "isoWeekday"), I("day", "d"),
        I("weekday", "e"), I("isoWeekday", "E"), L("day", 11), L("weekday", 11), L("isoWeekday", 11), Y("d", He), Y("e", He), Y("E", He), Y("dd", function (a, b) {
    ...
    var kg = a, lg = (kg.defineLocale("af", {
        ...
        longDateFormat: {
            LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY",
            LL: "D MMMM YYYY թ.", LLL: "D MMMM YYYY թ., HH:mm", LLLL: "dddd, D MMMM YYYY թ., HH:mm"
        },
        calendar: {
    ...
    if (window.Select2 === b) {
        ...
        J = a(document), H = function () {
            ...
            createContainer: function () {
                ...
                for (var b = b.slice(0), a = a.slice(0), c = 0; c < b.length; c++)for (var d = 0; d < a.length; d++)if (g(this.opts.id(b[c]), this.opts.id(a[d]))) {
            ...
            formatMatches: function (a) {
                ...
                return "Вы можете выбрать только " + a + " станцию" + (1 == a ? "" : "s")
    ...
    $(".st-pic__item").click(function () {
        $(".st-pic__item").removeClass("active", 300), $(".st-pic__item-wrap .st-list").fadeOut(100), $(this).siblings(".st-list").fadeIn(100), $(this).addClass("active", 200), $(this).parents(".st-bxslider__wrap").addClass("move", 500), $(".st-img").fadeIn(100)
    }), $(".st-list .st-list__title .st-list__title-text .close_btn").click(function () {
        $(this).parents(".st-list").fadeOut(300), $(this).parents(".st-list").siblings(".st-pic__item").removeClass("active", 500), $(this).parents(".st-bxslider__wrap").removeClass("move", 500)
    }), $(document).ready(function () {
        $(".st-bxslider").bxSlider({mode: "fade"})
    })
}), $(document).ready(function () {
    $.exists(".st-title") && $(window).on("load", function () {
        var a = $(".cloud");
        a.delay(2350).fadeOut("slow")
    })
}), $(document).ready(function () {
    $(document).ready(function () {
        $("#st-slider").bxSlider({mode: "fade", speed: 10})
    }), $(window).on("load", function () {
        var a = $("#preloader");
        a.delay(10).fadeOut("slow")
    })
}), 
    /*function () {
    "use strict";
    ...
    var b, c = function (a, d) {
        ...
        function g() {
            r.autoplayTimeoutId = setTimeout(function () {
                r.params.loop ? (r.fixLoop(), r._slideNext()) : r.isEnd ? d.autoplayStopOnLast ? r.stopAutoplay() : r._slideTo(0) : r._slideNext()
            }, r.params.autoplay)
        }
        ...
        function i(a, b) {
            ...
            var c = window.MutationObserver || window.WebkitMutationObserver, d = new c(function (a) {
                a.forEach(function (a) {
                    r.onResize(!0), r.emit("onObserverUpdate", r, a)
                })
            });
            d.observe(a, {
        ...
        function j(a) {
            ...
            if (!r.params.allowSwipeToNext && (e() && 39 === b || !e() && 40 === b))return !1;
            if (!r.params.allowSwipeToPrev && (e() && 37 === b || !e() && 38 === b))return !1;
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === b || 39 === b || 38 === b || 40 === b) {
                    var c = !1;
                    if (r.container.parents(".swiper-slide").length > 0 && 0 === r.container.parents(".swiper-slide-active").length)return;
                    var d = {
                        left: window.pageXOffset,
                        top: window.pageYOffset
                    }, f = window.innerWidth, g = window.innerHeight, h = r.container.offset();
                    r.rtl && (h.left = h.left - r.container[0].scrollLeft);
                    for (var i = [[h.left, h.top], [h.left + r.width, h.top], [h.left, h.top + r.height], [h.left + r.width, h.top + r.height]], j = 0; j < i.length; j++) {
                        var k = i[j];
                        k[0] >= d.left && k[0] <= d.left + f && k[1] >= d.top && k[1] <= d.top + g && (c = !0)
                    }
                    if (!c)return
                }
                e() ? ((37 === b || 39 === b) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), (39 === b && !r.rtl || 37 === b && r.rtl) && r.slideNext(), (37 === b && !r.rtl || 39 === b && r.rtl) && r.slidePrev()) : ((38 === b || 40 === b) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), 40 === b && r.slideNext(), 38 === b && r.slidePrev())
            }
        }

        function k(a) {
            a.originalEvent && (a = a.originalEvent);
            var b = r.mousewheel.event, c = 0;
            if (a.detail)c = -a.detail; else if ("mousewheel" === b)if (r.params.mousewheelForceToAxis)if (e()) {
                if (!(Math.abs(a.wheelDeltaX) > Math.abs(a.wheelDeltaY)))return;
                c = a.wheelDeltaX
            } else {
                if (!(Math.abs(a.wheelDeltaY) > Math.abs(a.wheelDeltaX)))return;
                c = a.wheelDeltaY
            } else c = a.wheelDelta; else if ("DOMMouseScroll" === b)c = -a.detail; else if ("wheel" === b)if (r.params.mousewheelForceToAxis)if (e()) {
                if (!(Math.abs(a.deltaX) > Math.abs(a.deltaY)))return;
                c = -a.deltaX
            } else {
                if (!(Math.abs(a.deltaY) > Math.abs(a.deltaX)))return;
                c = -a.deltaY
            } else c = Math.abs(a.deltaX) > Math.abs(a.deltaY) ? -a.deltaX : -a.deltaY;
            if (r.params.mousewheelInvert && (c = -c), r.params.freeMode) {
                var d = r.getWrapperTranslate() + c * r.params.mousewheelSensitivity;
                if (d > r.minTranslate() && (d = r.minTranslate()), d < r.maxTranslate() && (d = r.maxTranslate()), r.setWrapperTransition(0), r.setWrapperTranslate(d), r.updateProgress(), r.updateActiveIndex(), r.params.freeModeSticky && (clearTimeout(r.mousewheel.timeout), r.mousewheel.timeout = setTimeout(function () {
                        r.slideReset()
                    }, 300)), 0 === d || d === r.maxTranslate())return
            } else {
                if ((new window.Date).getTime() - r.mousewheel.lastScrollTime > 60)if (0 > c)if (r.isEnd && !r.params.loop || r.animating) {
                    if (r.params.mousewheelReleaseOnEdges)return !0
                } else r.slideNext(); else if (r.isBeginning && !r.params.loop || r.animating) {
                    if (r.params.mousewheelReleaseOnEdges)return !0
                } else r.slidePrev();
                r.mousewheel.lastScrollTime = (new window.Date).getTime()
            }
            return r.params.autoplay && r.stopAutoplay(), a.preventDefault ? a.preventDefault() : a.returnValue = !1, !1
        }

        function l(a, c) {
            a = b(a);
            var d, f, g;
            d = a.attr("data-swiper-parallax") || "0", f = a.attr("data-swiper-parallax-x"), g = a.attr("data-swiper-parallax-y"), f || g ? (f = f || "0", g = g || "0") : e() ? (f = d, g = "0") : (g = d, f = "0"), f = f.indexOf("%") >= 0 ? parseInt(f, 10) * c + "%" : f * c + "px", g = g.indexOf("%") >= 0 ? parseInt(g, 10) * c + "%" : g * c + "px", a.transform("translate3d(" + f + ", " + g + ",0px)")
        }
        ...
        if (r.params = d, r.classNames = [], "undefined" != typeof b && "undefined" != typeof Dom7 && (b = Dom7), ("undefined" != typeof b || (b = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (r.$ = b, r.container = b(a), 0 !== r.container.length)) {
            ...
            r.container[0].swiper = r, r.container.data("swiper", r), r.classNames.push("swiper-container-" + r.params.direction), r.params.freeMode && r.classNames.push("swiper-container-free-mode"), r.support.flexbox || (r.classNames.push("swiper-container-no-flexbox"), r.params.slidesPerColumn = 1), (r.params.parallax || r.params.watchSlidesVisibility) && (r.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(r.params.effect) >= 0 && (r.support.transforms3d ? (r.params.watchSlidesProgress = !0, r.classNames.push("swiper-container-3d")) : r.params.effect = "slide"), "slide" !== r.params.effect && r.classNames.push("swiper-container-" + r.params.effect), "cube" === r.params.effect && (r.params.resistanceRatio = 0, r.params.slidesPerView = 1, r.params.slidesPerColumn = 1, r.params.slidesPerGroup = 1, r.params.centeredSlides = !1, r.params.spaceBetween = 0, r.params.virtualTranslate = !0, r.params.setWrapperSize = !1), "fade" === r.params.effect && (r.params.slidesPerView = 1, r.params.slidesPerColumn = 1, r.params.slidesPerGroup = 1, r.params.watchSlidesProgress = !0, r.params.spaceBetween = 0, "undefined" == typeof o && (r.params.virtualTranslate = !0)), r.params.grabCursor && r.support.touch && (r.params.grabCursor = !1), r.wrapper = r.container.children("." + r.params.wrapperClass), r.params.pagination && (r.paginationContainer = b(r.params.pagination), r.params.paginationClickable && r.paginationContainer.addClass("swiper-pagination-clickable")), r.rtl = e() && ("rtl" === r.container[0].dir.toLowerCase() || "rtl" === r.container.css("direction")), r.rtl && r.classNames.push("swiper-container-rtl"), r.rtl && (r.wrongRTL = "-webkit-box" === r.wrapper.css("display")), r.params.slidesPerColumn > 1 && r.classNames.push("swiper-container-multirow"), r.device.android && r.classNames.push("swiper-container-android"), r.container.addClass(r.classNames.join(" ")), r.translate = 0, r.progress = 0, r.velocity = 0, r.lockSwipeToNext = function () {
            ...
            }, r.params.grabCursor && (r.container[0].style.cursor = "move", r.container[0].style.cursor = "-webkit-grab", r.container[0].style.cursor = "-moz-grab", r.container[0].style.cursor = "grab"), r.imagesToLoad = [], r.imagesLoaded = 0, r.loadImage = function (a, b, c, d, e) {
                function f() {
                    e && e()
                }
                ...
                function a() {
                    "undefined" != typeof r && null !== r && (void 0 !== r.imagesLoaded && r.imagesLoaded++, r.imagesLoaded === r.imagesToLoad.length && (r.params.updateOnImagesReady && r.update(), r.emit("onImagesReady", r)))
                }

                r.imagesToLoad = r.container.find("img");
                for (var b = 0; b < r.imagesToLoad.length; b++)r.loadImage(r.imagesToLoad[b], r.imagesToLoad[b].currentSrc || r.imagesToLoad[b].getAttribute("src"), r.imagesToLoad[b].srcset || r.imagesToLoad[b].getAttribute("srcset"), !0, a)
            }, r.autoplayTimeoutId = void 0, r.autoplaying = !1, r.autoplayPaused = !1, r.startAutoplay = function () {
                return "undefined" != typeof r.autoplayTimeoutId ? !1 : r.params.autoplay ? r.autoplaying ? !1 : (r.autoplaying = !0, r.emit("onAutoplayStart", r), void g()) : !1
            }, r.stopAutoplay = function (a) {
            ...
            }, r.pauseAutoplay = function (a) {
                r.autoplayPaused || (r.autoplayTimeoutId && clearTimeout(r.autoplayTimeoutId), r.autoplayPaused = !0, 0 === a ? (r.autoplayPaused = !1, g()) : r.wrapper.transitionEnd(function () {
                    r && (r.autoplayPaused = !1, r.autoplaying ? g() : r.stopAutoplay())
                }))
                ...
                var a, b;
                a = "undefined" != typeof r.params.width ? r.params.width : r.container[0].clientWidth, b = "undefined" != typeof r.params.height ? r.params.height : r.container[0].clientHeight, 0 === a && e() || 0 === b && !e() || (r.width = a, r.height = b, r.size = e() ? r.width : r.height)
            }, r.updateSlidesSize = function () {
                r.slides = r.wrapper.children("." + r.params.slideClass), r.snapGrid = [], r.slidesGrid = [], r.slidesSizesGrid = [];
                var a, b = r.params.spaceBetween, c = -r.params.slidesOffsetBefore, d = 0, g = 0;
                "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * r.size), r.virtualSize = -b, r.rtl ? r.slides.css({
                    marginLeft: "",
                    marginTop: ""
                }) : r.slides.css({marginRight: "", marginBottom: ""});
                var h;
                r.params.slidesPerColumn > 1 && (h = Math.floor(r.slides.length / r.params.slidesPerColumn) === r.slides.length / r.params.slidesPerColumn ? r.slides.length : Math.ceil(r.slides.length / r.params.slidesPerColumn) * r.params.slidesPerColumn, "auto" !== r.params.slidesPerView && "row" === r.params.slidesPerColumnFill && (h = Math.max(h, r.params.slidesPerView * r.params.slidesPerColumn)));
                var i, j = r.params.slidesPerColumn, k = h / j, l = k - (r.params.slidesPerColumn * k - r.slides.length);
                for (a = 0; a < r.slides.length; a++) {
                    i = 0;
                    var m = r.slides.eq(a);
                    if (r.params.slidesPerColumn > 1) {
                        var n, o, p;
                        "column" === r.params.slidesPerColumnFill ? (o = Math.floor(a / j), p = a - o * j, (o > l || o === l && p === j - 1) && ++p >= j && (p = 0, o++), n = o + p * h / j, m.css({
                            "-webkit-box-ordinal-group": n,
                            "-moz-box-ordinal-group": n,
                            "-ms-flex-order": n,
                            "-webkit-order": n,
                            order: n
                        })) : (p = Math.floor(a / k), o = a - p * k), m.css({"margin-top": 0 !== p && r.params.spaceBetween && r.params.spaceBetween + "px"}).attr("data-swiper-column", o).attr("data-swiper-row", p)
                    }
                    "none" !== m.css("display") && ("auto" === r.params.slidesPerView ? (i = e() ? m.outerWidth(!0) : m.outerHeight(!0), r.params.roundLengths && (i = f(i))) : (i = (r.size - (r.params.slidesPerView - 1) * b) / r.params.slidesPerView, r.params.roundLengths && (i = f(i)), e() ? r.slides[a].style.width = i + "px" : r.slides[a].style.height = i + "px"), r.slides[a].swiperSlideSize = i, r.slidesSizesGrid.push(i), r.params.centeredSlides ? (c = c + i / 2 + d / 2 + b, 0 === a && (c = c - r.size / 2 - b), Math.abs(c) < .001 && (c = 0), g % r.params.slidesPerGroup === 0 && r.snapGrid.push(c), r.slidesGrid.push(c)) : (g % r.params.slidesPerGroup === 0 && r.snapGrid.push(c), r.slidesGrid.push(c), c = c + i + b), r.virtualSize += i + b, d = i, g++)
                }
                r.virtualSize = Math.max(r.virtualSize, r.size) + r.params.slidesOffsetAfter;
                var q;
                if (r.rtl && r.wrongRTL && ("slide" === r.params.effect || "coverflow" === r.params.effect) && r.wrapper.css({width: r.virtualSize + r.params.spaceBetween + "px"}), (!r.support.flexbox || r.params.setWrapperSize) && (e() ? r.wrapper.css({width: r.virtualSize + r.params.spaceBetween + "px"}) : r.wrapper.css({height: r.virtualSize + r.params.spaceBetween + "px"})), r.params.slidesPerColumn > 1 && (r.virtualSize = (i + r.params.spaceBetween) * h, r.virtualSize = Math.ceil(r.virtualSize / r.params.slidesPerColumn) - r.params.spaceBetween, r.wrapper.css({width: r.virtualSize + r.params.spaceBetween + "px"}), r.params.centeredSlides)) {
                    for (q = [], a = 0; a < r.snapGrid.length; a++)r.snapGrid[a] < r.virtualSize + r.snapGrid[0] && q.push(r.snapGrid[a]);
                    r.snapGrid = q
                }
                if (!r.params.centeredSlides) {
                    for (q = [], a = 0; a < r.snapGrid.length; a++)r.snapGrid[a] <= r.virtualSize - r.size && q.push(r.snapGrid[a]);
                    r.snapGrid = q, Math.floor(r.virtualSize - r.size) > Math.floor(r.snapGrid[r.snapGrid.length - 1]) && r.snapGrid.push(r.virtualSize - r.size)
                }
                0 === r.snapGrid.length && (r.snapGrid = [0]), 0 !== r.params.spaceBetween && (e() ? r.rtl ? r.slides.css({marginLeft: b + "px"}) : r.slides.css({marginRight: b + "px"}) : r.slides.css({marginBottom: b + "px"})), r.params.watchSlidesProgress && r.updateSlidesOffset()
            }, r.updateSlidesOffset = function () {
                for (var a = 0; a < r.slides.length; a++)r.slides[a].swiperSlideOffset = e() ? r.slides[a].offsetLeft : r.slides[a].offsetTop
            }, r.updateSlidesProgress = function (a) {
                if ("undefined" == typeof a && (a = r.translate || 0), 0 !== r.slides.length) {
                    "undefined" == typeof r.slides[0].swiperSlideOffset && r.updateSlidesOffset();
                    var b = -a;
                    r.rtl && (b = a);
                    r.container[0].getBoundingClientRect(), e() ? "left" : "top", e() ? "right" : "bottom";
                    r.slides.removeClass(r.params.slideVisibleClass);
                    for (var c = 0; c < r.slides.length; c++) {
                        var d = r.slides[c], f = (b - d.swiperSlideOffset) / (d.swiperSlideSize + r.params.spaceBetween);
                        if (r.params.watchSlidesVisibility) {
                            var g = -(b - d.swiperSlideOffset), h = g + r.slidesSizesGrid[c], i = g >= 0 && g < r.size || h > 0 && h <= r.size || 0 >= g && h >= r.size;
                            i && r.slides.eq(c).addClass(r.params.slideVisibleClass)
                        }
                        d.progress = r.rtl ? -f : f
                    }
                }
            }, r.updateProgress = function (a) {
                "undefined" == typeof a && (a = r.translate || 0);
                var b = r.maxTranslate() - r.minTranslate();
                0 === b ? (r.progress = 0, r.isBeginning = r.isEnd = !0) : (r.progress = (a - r.minTranslate()) / b, r.isBeginning = r.progress <= 0, r.isEnd = r.progress >= 1), r.isBeginning && r.emit("onReachBeginning", r), r.isEnd && r.emit("onReachEnd", r), r.params.watchSlidesProgress && r.updateSlidesProgress(a), r.emit("onProgress", r, r.progress)
            }, r.updateActiveIndex = function () {
                var a, b, c, d = r.rtl ? r.translate : -r.translate;
                for (b = 0; b < r.slidesGrid.length; b++)"undefined" != typeof r.slidesGrid[b + 1] ? d >= r.slidesGrid[b] && d < r.slidesGrid[b + 1] - (r.slidesGrid[b + 1] - r.slidesGrid[b]) / 2 ? a = b : d >= r.slidesGrid[b] && d < r.slidesGrid[b + 1] && (a = b + 1) : d >= r.slidesGrid[b] && (a = b);
                (0 > a || "undefined" == typeof a) && (a = 0), c = Math.floor(a / r.params.slidesPerGroup), c >= r.snapGrid.length && (c = r.snapGrid.length - 1), a !== r.activeIndex && (r.snapIndex = c, r.previousIndex = r.activeIndex, r.activeIndex = a, r.updateClasses())
            }, r.updateClasses = function () {
                r.slides.removeClass(r.params.slideActiveClass + " " + r.params.slideNextClass + " " + r.params.slidePrevClass);
                var a = r.slides.eq(r.activeIndex);
                if (a.addClass(r.params.slideActiveClass), a.next("." + r.params.slideClass).addClass(r.params.slideNextClass), a.prev("." + r.params.slideClass).addClass(r.params.slidePrevClass), r.bullets && r.bullets.length > 0) {
                    r.bullets.removeClass(r.params.bulletActiveClass);
                    var c;
                    r.params.loop ? (c = Math.ceil(r.activeIndex - r.loopedSlides) / r.params.slidesPerGroup, c > r.slides.length - 1 - 2 * r.loopedSlides && (c -= r.slides.length - 2 * r.loopedSlides), c > r.bullets.length - 1 && (c -= r.bullets.length)) : c = "undefined" != typeof r.snapIndex ? r.snapIndex : r.activeIndex || 0, r.paginationContainer.length > 1 ? r.bullets.each(function () {
                        b(this).index() === c && b(this).addClass(r.params.bulletActiveClass)
                    }) : r.bullets.eq(c).addClass(r.params.bulletActiveClass)
                }
                r.params.loop || (r.params.prevButton && (r.isBeginning ? (b(r.params.prevButton).addClass(r.params.buttonDisabledClass), r.params.a11y && r.a11y && r.a11y.disable(b(r.params.prevButton))) : (b(r.params.prevButton).removeClass(r.params.buttonDisabledClass), r.params.a11y && r.a11y && r.a11y.enable(b(r.params.prevButton)))), r.params.nextButton && (r.isEnd ? (b(r.params.nextButton).addClass(r.params.buttonDisabledClass), r.params.a11y && r.a11y && r.a11y.disable(b(r.params.nextButton))) : (b(r.params.nextButton).removeClass(r.params.buttonDisabledClass), r.params.a11y && r.a11y && r.a11y.enable(b(r.params.nextButton)))))
            }, r.updatePagination = function () {
                if (r.params.pagination && r.paginationContainer && r.paginationContainer.length > 0) {
                    for (var a = "", b = r.params.loop ? Math.ceil((r.slides.length - 2 * r.loopedSlides) / r.params.slidesPerGroup) : r.snapGrid.length, c = 0; b > c; c++)a += r.params.paginationBulletRender ? r.params.paginationBulletRender(c, r.params.bulletClass) : "<" + r.params.paginationElement + ' class="' + r.params.bulletClass + '"></' + r.params.paginationElement + ">";
                    r.paginationContainer.html(a), r.bullets = r.paginationContainer.find("." + r.params.bulletClass), r.params.paginationClickable && r.params.a11y && r.a11y && r.a11y.initPagination()
                }
            }, r.update = function (a) {
                function b() {
                    d = Math.min(Math.max(r.translate, r.maxTranslate()), r.minTranslate()), r.setWrapperTranslate(d), r.updateActiveIndex(), r.updateClasses()
                }

                if (r.updateContainerSize(), r.updateSlidesSize(), r.updateProgress(), r.updatePagination(), r.updateClasses(), r.params.scrollbar && r.scrollbar && r.scrollbar.set(), a) {
                    var c, d;
                    r.controller && r.controller.spline && (r.controller.spline = void 0), r.params.freeMode ? b() : (c = ("auto" === r.params.slidesPerView || r.params.slidesPerView > 1) && r.isEnd && !r.params.centeredSlides ? r.slideTo(r.slides.length - 1, 0, !1, !0) : r.slideTo(r.activeIndex, 0, !1, !0), c || b())
                }
            }, r.onResize = function (a) {
                var b = r.params.allowSwipeToPrev, c = r.params.allowSwipeToNext;
                if (r.params.allowSwipeToPrev = r.params.allowSwipeToNext = !0, r.updateContainerSize(), r.updateSlidesSize(), ("auto" === r.params.slidesPerView || r.params.freeMode || a) && r.updatePagination(), r.params.scrollbar && r.scrollbar && r.scrollbar.set(), r.controller && r.controller.spline && (r.controller.spline = void 0), r.params.freeMode) {
                    var d = Math.min(Math.max(r.translate, r.maxTranslate()), r.minTranslate());
                    r.setWrapperTranslate(d), r.updateActiveIndex(), r.updateClasses()
                } else r.updateClasses(), ("auto" === r.params.slidesPerView || r.params.slidesPerView > 1) && r.isEnd && !r.params.centeredSlides ? r.slideTo(r.slides.length - 1, 0, !1, !0) : r.slideTo(r.activeIndex, 0, !1, !0);
                r.params.allowSwipeToPrev = b, r.params.allowSwipeToNext = c
            };
            var s = ["mousedown", "mousemove", "mouseup"];
            window.navigator.pointerEnabled ? s = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (s = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), r.touchEvents = {
                start: r.support.touch || !r.params.simulateTouch ? "touchstart" : s[0],
                move: r.support.touch || !r.params.simulateTouch ? "touchmove" : s[1],
                end: r.support.touch || !r.params.simulateTouch ? "touchend" : s[2]
            }, (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && ("container" === r.params.touchEventsTarget ? r.container : r.wrapper).addClass("swiper-wp8-" + r.params.direction), r.initEvents = function (a) {
                var c = a ? "off" : "on", e = a ? "removeEventListener" : "addEventListener", f = "container" === r.params.touchEventsTarget ? r.container[0] : r.wrapper[0], g = r.support.touch ? f : document, h = r.params.nested ? !0 : !1;
                r.browser.ie ? (f[e](r.touchEvents.start, r.onTouchStart, !1), g[e](r.touchEvents.move, r.onTouchMove, h), g[e](r.touchEvents.end, r.onTouchEnd, !1)) : (r.support.touch && (f[e](r.touchEvents.start, r.onTouchStart, !1), f[e](r.touchEvents.move, r.onTouchMove, h), f[e](r.touchEvents.end, r.onTouchEnd, !1)), !d.simulateTouch || r.device.ios || r.device.android || (f[e]("mousedown", r.onTouchStart, !1), document[e]("mousemove", r.onTouchMove, h), document[e]("mouseup", r.onTouchEnd, !1))), window[e]("resize", r.onResize), r.params.nextButton && (b(r.params.nextButton)[c]("click", r.onClickNext), r.params.a11y && r.a11y && b(r.params.nextButton)[c]("keydown", r.a11y.onEnterKey)), r.params.prevButton && (b(r.params.prevButton)[c]("click", r.onClickPrev), r.params.a11y && r.a11y && b(r.params.prevButton)[c]("keydown", r.a11y.onEnterKey)), r.params.pagination && r.params.paginationClickable && (b(r.paginationContainer)[c]("click", "." + r.params.bulletClass, r.onClickIndex), r.params.a11y && r.a11y && b(r.paginationContainer)[c]("keydown", "." + r.params.bulletClass, r.a11y.onEnterKey)), (r.params.preventClicks || r.params.preventClicksPropagation) && f[e]("click", r.preventClicks, !0)
            }, r.attachEvents = function (a) {
                r.initEvents()
            }, r.detachEvents = function () {
                r.initEvents(!0)
            }, r.allowClick = !0, r.preventClicks = function (a) {
                r.allowClick || (r.params.preventClicks && a.preventDefault(), r.params.preventClicksPropagation && r.animating && (a.stopPropagation(), a.stopImmediatePropagation()))
            }, r.onClickNext = function (a) {
                a.preventDefault(), (!r.isEnd || r.params.loop) && r.slideNext()
            }, r.onClickPrev = function (a) {
                a.preventDefault(), (!r.isBeginning || r.params.loop) && r.slidePrev()
            }, r.onClickIndex = function (a) {
                a.preventDefault();
                var c = b(this).index() * r.params.slidesPerGroup;
                r.params.loop && (c += r.loopedSlides), r.slideTo(c)
            }, r.updateClickedSlide = function (a) {
                var c = h(a, "." + r.params.slideClass), d = !1;
                if (c)for (var e = 0; e < r.slides.length; e++)r.slides[e] === c && (d = !0);
                if (!c || !d)return r.clickedSlide = void 0, void(r.clickedIndex = void 0);
                if (r.clickedSlide = c, r.clickedIndex = b(c).index(), r.params.slideToClickedSlide && void 0 !== r.clickedIndex && r.clickedIndex !== r.activeIndex) {
                    var f, g = r.clickedIndex;
                    if (r.params.loop) {
                        if (r.animating)return;
                        f = b(r.clickedSlide).attr("data-swiper-slide-index"), r.params.centeredSlides ? g < r.loopedSlides - r.params.slidesPerView / 2 || g > r.slides.length - r.loopedSlides + r.params.slidesPerView / 2 ? (r.fixLoop(), g = r.wrapper.children("." + r.params.slideClass + '[data-swiper-slide-index="' + f + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function () {
                            r.slideTo(g)
                        }, 0)) : r.slideTo(g) : g > r.slides.length - r.params.slidesPerView ? (r.fixLoop(), g = r.wrapper.children("." + r.params.slideClass + '[data-swiper-slide-index="' + f + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function () {
                            r.slideTo(g)
                        }, 0)) : r.slideTo(g)
                    } else r.slideTo(g)
                }
            };
            var t, u, v, w, x, y, z, A, B, C = "input, select, textarea, button", D = Date.now(), E = [];
            r.animating = !1, r.touches = {startX: 0, startY: 0, currentX: 0, currentY: 0, diff: 0};
            var F, G;
            if (r.onTouchStart = function (a) {
                    if (a.originalEvent && (a = a.originalEvent), F = "touchstart" === a.type, F || !("which" in a) || 3 !== a.which) {
                        if (r.params.noSwiping && h(a, "." + r.params.noSwipingClass))return void(r.allowClick = !0);
                        if (!r.params.swipeHandler || h(a, r.params.swipeHandler)) {
                            var c = r.touches.currentX = "touchstart" === a.type ? a.targetTouches[0].pageX : a.pageX, d = r.touches.currentY = "touchstart" === a.type ? a.targetTouches[0].pageY : a.pageY;
                            if (!(r.device.ios && r.params.iOSEdgeSwipeDetection && c <= r.params.iOSEdgeSwipeThreshold)) {
                                if (t = !0, u = !1, w = void 0, G = void 0, r.touches.startX = c, r.touches.startY = d, v = Date.now(), r.allowClick = !0, r.updateContainerSize(), r.swipeDirection = void 0, r.params.threshold > 0 && (z = !1), "touchstart" !== a.type) {
                                    var e = !0;
                                    b(a.target).is(C) && (e = !1), document.activeElement && b(document.activeElement).is(C) && document.activeElement.blur(), e && a.preventDefault()
                                }
                                r.emit("onTouchStart", r, a)
                            }
                        }
                    }
                }, r.onTouchMove = function (a) {
                    if (a.originalEvent && (a = a.originalEvent), !(F && "mousemove" === a.type || a.preventedByNestedSwiper)) {
                        if (r.params.onlyExternal)return r.allowClick = !1, void(t && (r.touches.startX = r.touches.currentX = "touchmove" === a.type ? a.targetTouches[0].pageX : a.pageX, r.touches.startY = r.touches.currentY = "touchmove" === a.type ? a.targetTouches[0].pageY : a.pageY, v = Date.now()));
                        if (F && document.activeElement && a.target === document.activeElement && b(a.target).is(C))return u = !0, void(r.allowClick = !1);
                        if (r.emit("onTouchMove", r, a), !(a.targetTouches && a.targetTouches.length > 1)) {
                            if (r.touches.currentX = "touchmove" === a.type ? a.targetTouches[0].pageX : a.pageX, r.touches.currentY = "touchmove" === a.type ? a.targetTouches[0].pageY : a.pageY, "undefined" == typeof w) {
                                var c = 180 * Math.atan2(Math.abs(r.touches.currentY - r.touches.startY), Math.abs(r.touches.currentX - r.touches.startX)) / Math.PI;
                                w = e() ? c > r.params.touchAngle : 90 - c > r.params.touchAngle
                            }
                            if (w && r.emit("onTouchMoveOpposite", r, a), "undefined" == typeof G && r.browser.ieTouch && (r.touches.currentX !== r.touches.startX || r.touches.currentY !== r.touches.startY) && (G = !0), t) {
                                if (w)return void(t = !1);
                                if (G || !r.browser.ieTouch) {
                                    r.allowClick = !1, r.emit("onSliderMove", r, a), a.preventDefault(), r.params.touchMoveStopPropagation && !r.params.nested && a.stopPropagation(), u || (d.loop && r.fixLoop(), y = r.getWrapperTranslate(), r.setWrapperTransition(0), r.animating && r.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), r.params.autoplay && r.autoplaying && (r.params.autoplayDisableOnInteraction ? r.stopAutoplay() : r.pauseAutoplay()), B = !1, r.params.grabCursor && (r.container[0].style.cursor = "move", r.container[0].style.cursor = "-webkit-grabbing", r.container[0].style.cursor = "-moz-grabbin", r.container[0].style.cursor = "grabbing")), u = !0;
                                    var f = r.touches.diff = e() ? r.touches.currentX - r.touches.startX : r.touches.currentY - r.touches.startY;
                                    f *= r.params.touchRatio, r.rtl && (f = -f), r.swipeDirection = f > 0 ? "prev" : "next", x = f + y;
                                    var g = !0;
                                    if (f > 0 && x > r.minTranslate() ? (g = !1, r.params.resistance && (x = r.minTranslate() - 1 + Math.pow(-r.minTranslate() + y + f, r.params.resistanceRatio))) : 0 > f && x < r.maxTranslate() && (g = !1, r.params.resistance && (x = r.maxTranslate() + 1 - Math.pow(r.maxTranslate() - y - f, r.params.resistanceRatio))), g && (a.preventedByNestedSwiper = !0), !r.params.allowSwipeToNext && "next" === r.swipeDirection && y > x && (x = y), !r.params.allowSwipeToPrev && "prev" === r.swipeDirection && x > y && (x = y), r.params.followFinger) {
                                        if (r.params.threshold > 0) {
                                            if (!(Math.abs(f) > r.params.threshold || z))return void(x = y);
                                            if (!z)return z = !0, r.touches.startX = r.touches.currentX, r.touches.startY = r.touches.currentY, x = y, void(r.touches.diff = e() ? r.touches.currentX - r.touches.startX : r.touches.currentY - r.touches.startY)
                                        }
                                        (r.params.freeMode || r.params.watchSlidesProgress) && r.updateActiveIndex(), r.params.freeMode && (0 === E.length && E.push({
                                            position: r.touches[e() ? "startX" : "startY"],
                                            time: v
                                        }), E.push({
                                            position: r.touches[e() ? "currentX" : "currentY"],
                                            time: (new window.Date).getTime()
                                        })), r.updateProgress(x), r.setWrapperTranslate(x)
                                    }
                                }
                            }
                        }
                    ...
                    if (a.originalEvent && (a = a.originalEvent), r.emit("onTouchEnd", r, a), t) {
                        r.params.grabCursor && u && t && (r.container[0].style.cursor = "move", r.container[0].style.cursor = "-webkit-grab", r.container[0].style.cursor = "-moz-grab", r.container[0].style.cursor = "grab");
                        var c = Date.now(), d = c - v;
                        if (r.allowClick && (r.updateClickedSlide(a), r.emit("onTap", r, a), 300 > d && c - D > 300 && (A && clearTimeout(A), A = setTimeout(function () {
                                r && (r.params.paginationHide && r.paginationContainer.length > 0 && !b(a.target).hasClass(r.params.bulletClass) && r.paginationContainer.toggleClass(r.params.paginationHiddenClass), r.emit("onClick", r, a))
                            }, 300)), 300 > d && 300 > c - D && (A && clearTimeout(A), r.emit("onDoubleTap", r, a))), D = Date.now(), setTimeout(function () {
                                r && (r.allowClick = !0)
                            }, 0), !t || !u || !r.swipeDirection || 0 === r.touches.diff || x === y)return void(t = u = !1);
                        t = u = !1;
                        var e;
                        if (e = r.params.followFinger ? r.rtl ? r.translate : -r.translate : -x, r.params.freeMode) {
                            if (e < -r.minTranslate())return void r.slideTo(r.activeIndex);
                            if (e > -r.maxTranslate())return void(r.slides.length < r.snapGrid.length ? r.slideTo(r.snapGrid.length - 1) : r.slideTo(r.slides.length - 1));
                            if (r.params.freeModeMomentum) {
                                if (E.length > 1) {
                                    var f = E.pop(), g = E.pop(), h = f.position - g.position, i = f.time - g.time;
                                    r.velocity = h / i, r.velocity = r.velocity / 2, Math.abs(r.velocity) < r.params.freeModeMinimumVelocity && (r.velocity = 0), (i > 150 || (new window.Date).getTime() - f.time > 300) && (r.velocity = 0)
                                } else r.velocity = 0;
                                E.length = 0;
                                var j = 1e3 * r.params.freeModeMomentumRatio, k = r.velocity * j, l = r.translate + k;
                                r.rtl && (l = -l);
                                var m, n = !1, o = 20 * Math.abs(r.velocity) * r.params.freeModeMomentumBounceRatio;
                                if (l < r.maxTranslate())r.params.freeModeMomentumBounce ? (l + r.maxTranslate() < -o && (l = r.maxTranslate() - o), m = r.maxTranslate(), n = !0, B = !0) : l = r.maxTranslate(); else if (l > r.minTranslate())r.params.freeModeMomentumBounce ? (l - r.minTranslate() > o && (l = r.minTranslate() + o), m = r.minTranslate(), n = !0, B = !0) : l = r.minTranslate(); else if (r.params.freeModeSticky) {
                                    var p, q = 0;
                                    for (q = 0; q < r.snapGrid.length; q += 1)if (r.snapGrid[q] > -l) {
                                        p = q;
                                        break
                                    }
                                    l = Math.abs(r.snapGrid[p] - l) < Math.abs(r.snapGrid[p - 1] - l) || "next" === r.swipeDirection ? r.snapGrid[p] : r.snapGrid[p - 1], r.rtl || (l = -l)
                                }
                                if (0 !== r.velocity)j = r.rtl ? Math.abs((-l - r.translate) / r.velocity) : Math.abs((l - r.translate) / r.velocity); else if (r.params.freeModeSticky)return void r.slideReset();
                                r.params.freeModeMomentumBounce && n ? (r.updateProgress(m), r.setWrapperTransition(j), r.setWrapperTranslate(l), r.onTransitionStart(), r.animating = !0, r.wrapper.transitionEnd(function () {
                                    r && B && (r.emit("onMomentumBounce", r), r.setWrapperTransition(r.params.speed), r.setWrapperTranslate(m), r.wrapper.transitionEnd(function () {
                                        r && r.onTransitionEnd()
                                    }))
                                })) : r.velocity ? (r.updateProgress(l), r.setWrapperTransition(j), r.setWrapperTranslate(l), r.onTransitionStart(), r.animating || (r.animating = !0, r.wrapper.transitionEnd(function () {
                                    r && r.onTransitionEnd()
                                }))) : r.updateProgress(l), r.updateActiveIndex()
                            }
                            return void((!r.params.freeModeMomentum || d >= r.params.longSwipesMs) && (r.updateProgress(), r.updateActiveIndex()))
                        }
                        var s, w = 0, z = r.slidesSizesGrid[0];
                        for (s = 0; s < r.slidesGrid.length; s += r.params.slidesPerGroup)"undefined" != typeof r.slidesGrid[s + r.params.slidesPerGroup] ? e >= r.slidesGrid[s] && e < r.slidesGrid[s + r.params.slidesPerGroup] && (w = s, z = r.slidesGrid[s + r.params.slidesPerGroup] - r.slidesGrid[s]) : e >= r.slidesGrid[s] && (w = s, z = r.slidesGrid[r.slidesGrid.length - 1] - r.slidesGrid[r.slidesGrid.length - 2]);
                        var C = (e - r.slidesGrid[w]) / z;
                        if (d > r.params.longSwipesMs) {
                            if (!r.params.longSwipes)return void r.slideTo(r.activeIndex);
                            "next" === r.swipeDirection && (C >= r.params.longSwipesRatio ? r.slideTo(w + r.params.slidesPerGroup) : r.slideTo(w)), "prev" === r.swipeDirection && (C > 1 - r.params.longSwipesRatio ? r.slideTo(w + r.params.slidesPerGroup) : r.slideTo(w))
                        } else {
                            if (!r.params.shortSwipes)return void r.slideTo(r.activeIndex);
                            "next" === r.swipeDirection && r.slideTo(w + r.params.slidesPerGroup), "prev" === r.swipeDirection && r.slideTo(w)
                        }
                    }
                }, r._slideTo = function (a, b) {
                    return r.slideTo(a, b, !0, !0)
                }, r.slideTo = function (a, b, c, d) {
                    "undefined" == typeof c && (c = !0), "undefined" == typeof a && (a = 0), 0 > a && (a = 0), r.snapIndex = Math.floor(a / r.params.slidesPerGroup), r.snapIndex >= r.snapGrid.length && (r.snapIndex = r.snapGrid.length - 1);
                    var f = -r.snapGrid[r.snapIndex];
                    r.params.autoplay && r.autoplaying && (d || !r.params.autoplayDisableOnInteraction ? r.pauseAutoplay(b) : r.stopAutoplay()), r.updateProgress(f);
                    for (var g = 0; g < r.slidesGrid.length; g++)-Math.floor(100 * f) >= Math.floor(100 * r.slidesGrid[g]) && (a = g);
                    if (!r.params.allowSwipeToNext && f < r.translate && f < r.minTranslate())return !1;
                    if (!r.params.allowSwipeToPrev && f > r.translate && f > r.maxTranslate() && (r.activeIndex || 0) !== a)return !1;
                    if ("undefined" == typeof b && (b = r.params.speed), r.previousIndex = r.activeIndex || 0, r.activeIndex = a, f === r.translate)return r.updateClasses(), !1;
                    r.updateClasses(), r.onTransitionStart(c);
                    e() ? f : 0, e() ? 0 : f;
                    return 0 === b ? (r.setWrapperTransition(0), r.setWrapperTranslate(f), r.onTransitionEnd(c)) : (r.setWrapperTransition(b), r.setWrapperTranslate(f), r.animating || (r.animating = !0, r.wrapper.transitionEnd(function () {
                        r && r.onTransitionEnd(c)
                    }))), !0
                }, r.onTransitionStart = function (a) {
                    "undefined" == typeof a && (a = !0), r.lazy && r.lazy.onTransitionStart(), a && (r.emit("onTransitionStart", r), r.activeIndex !== r.previousIndex && r.emit("onSlideChangeStart", r))
                }, r.onTransitionEnd = function (a) {
                    r.animating = !1, r.setWrapperTransition(0), "undefined" == typeof a && (a = !0), r.lazy && r.lazy.onTransitionEnd(), a && (r.emit("onTransitionEnd", r), r.activeIndex !== r.previousIndex && r.emit("onSlideChangeEnd", r)), r.params.hashnav && r.hashnav && r.hashnav.setHash()
                }, r.slideNext = function (a, b, c) {
                    if (r.params.loop) {
                        if (r.animating)return !1;
                        r.fixLoop();
                        r.container[0].clientLeft;
                        return r.slideTo(r.activeIndex + r.params.slidesPerGroup, b, a, c)
                    }
                    return r.slideTo(r.activeIndex + r.params.slidesPerGroup, b, a, c)
                }, r._slideNext = function (a) {
                    return r.slideNext(!0, a, !0)
                }, r.slidePrev = function (a, b, c) {
                    if (r.params.loop) {
                        if (r.animating)return !1;
                        r.fixLoop();
                        r.container[0].clientLeft;
                        return r.slideTo(r.activeIndex - 1, b, a, c)
                    }
                    return r.slideTo(r.activeIndex - 1, b, a, c)
                }, r._slidePrev = function (a) {
                    return r.slidePrev(!0, a, !0)
                }, r.slideReset = function (a, b, c) {
                    return r.slideTo(r.activeIndex, b, a)
                }, r.setWrapperTransition = function (a, b) {
                    r.wrapper.transition(a), "slide" !== r.params.effect && r.effects[r.params.effect] && r.effects[r.params.effect].setTransition(a), r.params.parallax && r.parallax && r.parallax.setTransition(a), r.params.scrollbar && r.scrollbar && r.scrollbar.setTransition(a), r.params.control && r.controller && r.controller.setTransition(a, b), r.emit("onSetTransition", r, a)
                }, r.setWrapperTranslate = function (a, b, c) {
                    var d = 0, g = 0, h = 0;
                    e() ? d = r.rtl ? -a : a : g = a, r.params.roundLengths && (d = f(d), g = f(g)), r.params.virtualTranslate || (r.support.transforms3d ? r.wrapper.transform("translate3d(" + d + "px, " + g + "px, " + h + "px)") : r.wrapper.transform("translate(" + d + "px, " + g + "px)")), r.translate = e() ? d : g, b && r.updateActiveIndex(), "slide" !== r.params.effect && r.effects[r.params.effect] && r.effects[r.params.effect].setTranslate(r.translate), r.params.parallax && r.parallax && r.parallax.setTranslate(r.translate), r.params.scrollbar && r.scrollbar && r.scrollbar.setTranslate(r.translate), r.params.control && r.controller && r.controller.setTranslate(r.translate, c), r.emit("onSetTranslate", r, r.translate)
                }, r.getTranslate = function (a, b) {
                    var c, d, e, f;
                    return "undefined" == typeof b && (b = "x"), r.params.virtualTranslate ? r.rtl ? -r.translate : r.translate : (e = window.getComputedStyle(a, null), window.WebKitCSSMatrix ? (d = e.transform || e.webkitTransform, d.split(",").length > 6 && (d = d.split(", ").map(function (a) {
                        return a.replace(",", ".")
                    }).join(", ")), f = new window.WebKitCSSMatrix("none" === d ? "" : d)) : (f = e.MozTransform || e.OTransform || e.MsTransform || e.msTransform || e.transform || e.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), c = f.toString().split(",")), "x" === b && (d = window.WebKitCSSMatrix ? f.m41 : 16 === c.length ? parseFloat(c[12]) : parseFloat(c[4])), "y" === b && (d = window.WebKitCSSMatrix ? f.m42 : 16 === c.length ? parseFloat(c[13]) : parseFloat(c[5])), r.rtl && d && (d = -d), d || 0)
                }, r.getWrapperTranslate = function (a) {
                    return "undefined" == typeof a && (a = e() ? "x" : "y"), r.getTranslate(r.wrapper[0], a)
                }, r.observers = [], r.initObservers = function () {
                    if (r.params.observeParents)for (var a = r.container.parents(), b = 0; b < a.length; b++)i(a[b]);
                    i(r.container[0], {childList: !1}), i(r.wrapper[0], {attributes: !1})
                }, r.disconnectObservers = function () {
                    for (var a = 0; a < r.observers.length; a++)r.observers[a].disconnect();
                    r.observers = []
                }, r.createLoop = function () {
                    r.wrapper.children("." + r.params.slideClass + "." + r.params.slideDuplicateClass).remove();
                    var a = r.wrapper.children("." + r.params.slideClass);
                    "auto" !== r.params.slidesPerView || r.params.loopedSlides || (r.params.loopedSlides = a.length), r.loopedSlides = parseInt(r.params.loopedSlides || r.params.slidesPerView, 10), r.loopedSlides = r.loopedSlides + r.params.loopAdditionalSlides, r.loopedSlides > a.length && (r.loopedSlides = a.length);
                    var c, d = [], e = [];
                    for (a.each(function (c, f) {
                        var g = b(this);
                        c < r.loopedSlides && e.push(f), c < a.length && c >= a.length - r.loopedSlides && d.push(f), g.attr("data-swiper-slide-index", c)
                    }), c = 0; c < e.length; c++)r.wrapper.append(b(e[c].cloneNode(!0)).addClass(r.params.slideDuplicateClass));
                    for (c = d.length - 1; c >= 0; c--)r.wrapper.prepend(b(d[c].cloneNode(!0)).addClass(r.params.slideDuplicateClass))
                    ...
                    var a;
                    r.activeIndex < r.loopedSlides ? (a = r.slides.length - 3 * r.loopedSlides + r.activeIndex, a += r.loopedSlides, r.slideTo(a, 0, !1, !0)) : ("auto" === r.params.slidesPerView && r.activeIndex >= 2 * r.loopedSlides || r.activeIndex > r.slides.length - 2 * r.params.slidesPerView) && (a = -r.slides.length + r.activeIndex + r.loopedSlides, a += r.loopedSlides, r.slideTo(a, 0, !1, !0))
                }, r.appendSlide = function (a) {
                    if (r.params.loop && r.destroyLoop(), "object" == typeof a && a.length)for (var b = 0; b < a.length; b++)a[b] && r.wrapper.append(a[b]); else r.wrapper.append(a);
                    r.params.loop && r.createLoop(), r.params.observer && r.support.observer || r.update(!0)
                }, r.prependSlide = function (a) {
                    r.params.loop && r.destroyLoop();
                    var b = r.activeIndex + 1;
                    if ("object" == typeof a && a.length) {
                        for (var c = 0; c < a.length; c++)a[c] && r.wrapper.prepend(a[c]);
                        b = r.activeIndex + a.length
                    } else r.wrapper.prepend(a);
                    r.params.loop && r.createLoop(), r.params.observer && r.support.observer || r.update(!0), r.slideTo(b, 0, !1)
                }, r.removeSlide = function (a) {
                    r.params.loop && (r.destroyLoop(), r.slides = r.wrapper.children("." + r.params.slideClass));
                    var b, c = r.activeIndex;
                    if ("object" == typeof a && a.length) {
                        for (var d = 0; d < a.length; d++)b = a[d], r.slides[b] && r.slides.eq(b).remove(), c > b && c--;
                        c = Math.max(c, 0)
                    } else b = a, r.slides[b] && r.slides.eq(b).remove(), c > b && c--, c = Math.max(c, 0);
                    r.params.loop && r.createLoop(), r.params.observer && r.support.observer || r.update(!0), r.params.loop ? r.slideTo(c + r.loopedSlides, 0, !1) : r.slideTo(c, 0, !1)
                }, r.removeAllSlides = function () {
                    for (var a = [], b = 0; b < r.slides.length; b++)a.push(b);
                    r.removeSlide(a)
                }, r.effects = {
                    fade: {
                        setTranslate: function () {
                            for (var a = 0; a < r.slides.length; a++) {
                                var b = r.slides.eq(a), c = b[0].swiperSlideOffset, d = -c;
                                r.params.virtualTranslate || (d -= r.translate);
                                var f = 0;
                                e() || (f = d, d = 0);
                                var g = r.params.fade.crossFade ? Math.max(1 - Math.abs(b[0].progress), 0) : 1 + Math.min(Math.max(b[0].progress, -1), 0);
                                b.css({opacity: g}).transform("translate3d(" + d + "px, " + f + "px, 0px)")
                            }
                        }, setTransition: function (a) {
                            if (r.slides.transition(a), r.params.virtualTranslate && 0 !== a) {
                                var b = !1;
                                r.slides.transitionEnd(function () {
                                    if (!b && r) {
                                        b = !0, r.animating = !1;
                                        for (var a = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], c = 0; c < a.length; c++)r.wrapper.trigger(a[c])
                                    }
                                })
                            }
                        }
                        ...
                        setTranslate: function () {
                            var a, c = 0;
                            r.params.cube.shadow && (e() ? (a = r.wrapper.find(".swiper-cube-shadow"), 0 === a.length && (a = b('<div class="swiper-cube-shadow"></div>'), r.wrapper.append(a)), a.css({height: r.width + "px"})) : (a = r.container.find(".swiper-cube-shadow"), 0 === a.length && (a = b('<div class="swiper-cube-shadow"></div>'), r.container.append(a))));
                            for (var d = 0; d < r.slides.length; d++) {
                                var f = r.slides.eq(d), g = 90 * d, h = Math.floor(g / 360);
                                r.rtl && (g = -g, h = Math.floor(-g / 360));
                                var i = Math.max(Math.min(f[0].progress, 1), -1), j = 0, k = 0, l = 0;
                                d % 4 === 0 ? (j = 4 * -h * r.size, l = 0) : (d - 1) % 4 === 0 ? (j = 0, l = 4 * -h * r.size) : (d - 2) % 4 === 0 ? (j = r.size + 4 * h * r.size, l = r.size) : (d - 3) % 4 === 0 && (j = -r.size, l = 3 * r.size + 4 * r.size * h), r.rtl && (j = -j), e() || (k = j, j = 0);
                                var m = "rotateX(" + (e() ? 0 : -g) + "deg) rotateY(" + (e() ? g : 0) + "deg) translate3d(" + j + "px, " + k + "px, " + l + "px)";
                                if (1 >= i && i > -1 && (c = 90 * d + 90 * i, r.rtl && (c = 90 * -d - 90 * i)), f.transform(m), r.params.cube.slideShadows) {
                                    var n = e() ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"), o = e() ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");
                                    0 === n.length && (n = b('<div class="swiper-slide-shadow-' + (e() ? "left" : "top") + '"></div>'), f.append(n)), 0 === o.length && (o = b('<div class="swiper-slide-shadow-' + (e() ? "right" : "bottom") + '"></div>'), f.append(o));
                                    f[0].progress;
                                    n.length && (n[0].style.opacity = -f[0].progress), o.length && (o[0].style.opacity = f[0].progress)
                                }
                            }
                            if (r.wrapper.css({
                                ...
                                }), r.params.cube.shadow)if (e())a.transform("translate3d(0px, " + (r.width / 2 + r.params.cube.shadowOffset) + "px, " + -r.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + r.params.cube.shadowScale + ")"); else {
                                var p = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90), q = 1.5 - (Math.sin(2 * p * Math.PI / 360) / 2 + Math.cos(2 * p * Math.PI / 360) / 2), s = r.params.cube.shadowScale, t = r.params.cube.shadowScale / q, u = r.params.cube.shadowOffset;
                                a.transform("scale3d(" + s + ", 1, " + t + ") translate3d(0px, " + (r.height / 2 + u) + "px, " + -r.height / 2 / t + "px) rotateX(-90deg)")
                            }
                            var v = r.isSafari || r.isUiWebView ? -r.size / 2 : 0;
                            r.wrapper.transform("translate3d(0px,0," + v + "px) rotateX(" + (e() ? 0 : c) + "deg) rotateY(" + (e() ? -c : 0) + "deg)")
                        }, setTransition: function (a) {
                            r.slides.transition(a).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(a), r.params.cube.shadow && !e() && r.container.find(".swiper-cube-shadow").transition(a)
                        }
                    }, coverflow: {
                        setTranslate: function () {
                            for (var a = r.translate, c = e() ? -a + r.width / 2 : -a + r.height / 2, d = e() ? r.params.coverflow.rotate : -r.params.coverflow.rotate, f = r.params.coverflow.depth, g = 0, h = r.slides.length; h > g; g++) {
                                var i = r.slides.eq(g), j = r.slidesSizesGrid[g], k = i[0].swiperSlideOffset, l = (c - k - j / 2) / j * r.params.coverflow.modifier, m = e() ? d * l : 0, n = e() ? 0 : d * l, o = -f * Math.abs(l), p = e() ? 0 : r.params.coverflow.stretch * l, q = e() ? r.params.coverflow.stretch * l : 0;
                                Math.abs(q) < .001 && (q = 0), Math.abs(p) < .001 && (p = 0), Math.abs(o) < .001 && (o = 0), Math.abs(m) < .001 && (m = 0), Math.abs(n) < .001 && (n = 0);
                                var s = "translate3d(" + q + "px," + p + "px," + o + "px)  rotateX(" + n + "deg) rotateY(" + m + "deg)";
                                if (i.transform(s), i[0].style.zIndex = -Math.abs(Math.round(l)) + 1, r.params.coverflow.slideShadows) {
                                    ...
                                    0 === t.length && (t = b('<div class="swiper-slide-shadow-' + (e() ? "left" : "top") + '"></div>'), i.append(t)), 0 === u.length && (u = b('<div class="swiper-slide-shadow-' + (e() ? "right" : "bottom") + '"></div>'), i.append(u)), t.length && (t[0].style.opacity = l > 0 ? l : 0), u.length && (u[0].style.opacity = -l > 0 ? -l : 0)
                                }
                            }
                            if (r.browser.ie) {
                                var v = r.wrapper[0].style;
                                v.perspectiveOrigin = c + "px 50%"
                            }
                        }, setTransition: function (a) {
                            r.slides.transition(a).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(a)
                        }
                    }
                }, r.lazy = {
                    initialImageLoaded: !1, loadImageInSlide: function (a, c) {
                        if ("undefined" != typeof a && ("undefined" == typeof c && (c = !0), 0 !== r.slides.length)) {
                            var d = r.slides.eq(a), e = d.find(".swiper-lazy:not(.swiper-lazy-loaded):not(.swiper-lazy-loading)");
                            !d.hasClass("swiper-lazy") || d.hasClass("swiper-lazy-loaded") || d.hasClass("swiper-lazy-loading") || (e = e.add(d[0])), 0 !== e.length && e.each(function () {
                                ...
                                r.loadImage(a[0], f || e, g, !1, function () {
                                    if (e ? (a.css("background-image", "url(" + e + ")"), a.removeAttr("data-background")) : (g && (a.attr("srcset", g), a.removeAttr("data-srcset")), f && (a.attr("src", f), a.removeAttr("data-src"))), a.addClass("swiper-lazy-loaded").removeClass("swiper-lazy-loading"), d.find(".swiper-lazy-preloader, .preloader").remove(), r.params.loop && c) {
                                        var b = d.attr("data-swiper-slide-index");
                                        if (d.hasClass(r.params.slideDuplicateClass)) {
                                            var h = r.wrapper.children('[data-swiper-slide-index="' + b + '"]:not(.' + r.params.slideDuplicateClass + ")");
                                            r.lazy.loadImageInSlide(h.index(), !1)
                                        } else {
                                            var i = r.wrapper.children("." + r.params.slideDuplicateClass + '[data-swiper-slide-index="' + b + '"]');
                                            r.lazy.loadImageInSlide(i.index(), !1)
                                        }
                                    }
                                    r.emit("onLazyImageReady", r, d[0], a[0])
                                }), r.emit("onLazyImageLoad", r, d[0], a[0])
                            })
                        }
                    }, load: function () {
                        var a;
                        if (r.params.watchSlidesVisibility)r.wrapper.children("." + r.params.slideVisibleClass).each(function () {
                            r.lazy.loadImageInSlide(b(this).index())
                        }); else if (r.params.slidesPerView > 1)for (a = r.activeIndex; a < r.activeIndex + r.params.slidesPerView; a++)r.slides[a] && r.lazy.loadImageInSlide(a); else r.lazy.loadImageInSlide(r.activeIndex);
                        if (r.params.lazyLoadingInPrevNext)if (r.params.slidesPerView > 1) {
                            for (a = r.activeIndex + r.params.slidesPerView; a < r.activeIndex + r.params.slidesPerView + r.params.slidesPerView; a++)r.slides[a] && r.lazy.loadImageInSlide(a);
                            for (a = r.activeIndex - r.params.slidesPerView; a < r.activeIndex; a++)r.slides[a] && r.lazy.loadImageInSlide(a)
                        } else {
                            var c = r.wrapper.children("." + r.params.slideNextClass);
                            c.length > 0 && r.lazy.loadImageInSlide(c.index());
                            var d = r.wrapper.children("." + r.params.slidePrevClass);
                            d.length > 0 && r.lazy.loadImageInSlide(d.index())
                        }
                    ...
                    isTouched: !1, setDragPosition: function (a) {
                        var b = r.scrollbar, c = e() ? "touchstart" === a.type || "touchmove" === a.type ? a.targetTouches[0].pageX : a.pageX || a.clientX : "touchstart" === a.type || "touchmove" === a.type ? a.targetTouches[0].pageY : a.pageY || a.clientY, d = c - b.track.offset()[e() ? "left" : "top"] - b.dragSize / 2, f = -r.minTranslate() * b.moveDivider, g = -r.maxTranslate() * b.moveDivider;
                        f > d ? d = f : d > g && (d = g), d = -d / b.moveDivider, r.updateProgress(d), r.setWrapperTranslate(d, !0)
                    }, dragStart: function (a) {
                        var b = r.scrollbar;
                        b.isTouched = !0, a.preventDefault(), a.stopPropagation(), b.setDragPosition(a), clearTimeout(b.dragTimeout), b.track.transition(0), r.params.scrollbarHide && b.track.css("opacity", 1), r.wrapper.transition(100), b.drag.transition(100), r.emit("onScrollbarDragStart", r)
                    }, dragMove: function (a) {
                        var b = r.scrollbar;
                        b.isTouched && (a.preventDefault ? a.preventDefault() : a.returnValue = !1, b.setDragPosition(a), r.wrapper.transition(0), b.track.transition(0), b.drag.transition(0), r.emit("onScrollbarDragMove", r))
                    }, dragEnd: function (a) {
                        var b = r.scrollbar;
                        b.isTouched && (b.isTouched = !1, r.params.scrollbarHide && (clearTimeout(b.dragTimeout), b.dragTimeout = setTimeout(function () {
                        ...
                        var a = r.scrollbar, c = r.support.touch ? a.track : document;
                        b(a.track).on(r.touchEvents.start, a.dragStart), b(c).on(r.touchEvents.move, a.dragMove), b(c).on(r.touchEvents.end, a.dragEnd)
                    }, disableDraggable: function () {
                        var a = r.scrollbar, c = r.support.touch ? a.track : document;
                        b(a.track).off(r.touchEvents.start, a.dragStart), b(c).off(r.touchEvents.move, a.dragMove), b(c).off(r.touchEvents.end, a.dragEnd)
                    }, set: function () {
                        if (r.params.scrollbar) {
                            var a = r.scrollbar;
                            a.track = b(r.params.scrollbar), a.drag = a.track.find(".swiper-scrollbar-drag"), 0 === a.drag.length && (a.drag = b('<div class="swiper-scrollbar-drag"></div>'), a.track.append(a.drag)), a.drag[0].style.width = "", a.drag[0].style.height = "", a.trackSize = e() ? a.track[0].offsetWidth : a.track[0].offsetHeight, a.divider = r.size / r.virtualSize, a.moveDivider = a.divider * (a.trackSize / r.size), a.dragSize = a.trackSize * a.divider, e() ? a.drag[0].style.width = a.dragSize + "px" : a.drag[0].style.height = a.dragSize + "px", a.divider >= 1 ? a.track[0].style.display = "none" : a.track[0].style.display = "", r.params.scrollbarHide && (a.track[0].style.opacity = 0)
                        }
                    }, setTranslate: function () {
                        if (r.params.scrollbar) {
                            var a, b = r.scrollbar, c = (r.translate || 0, b.dragSize);
                            a = (b.trackSize - b.dragSize) * r.progress, r.rtl && e() ? (a = -a, a > 0 ? (c = b.dragSize - a, a = 0) : -a + b.dragSize > b.trackSize && (c = b.trackSize + a)) : 0 > a ? (c = b.dragSize + a, a = 0) : a + b.dragSize > b.trackSize && (c = b.trackSize - a), e() ? (r.support.transforms3d ? b.drag.transform("translate3d(" + a + "px, 0, 0)") : b.drag.transform("translateX(" + a + "px)"), b.drag[0].style.width = c + "px") : (r.support.transforms3d ? b.drag.transform("translate3d(0px, " + a + "px, 0)") : b.drag.transform("translateY(" + a + "px)"), b.drag[0].style.height = c + "px"), r.params.scrollbarHide && (clearTimeout(b.timeout), b.track[0].style.opacity = 1, b.timeout = setTimeout(function () {
                                b.track[0].style.opacity = 0, b.track.transition(400)
                            }, 1e3))
                        }
                    }, setTransition: function (a) {
                        r.params.scrollbar && r.scrollbar.drag.transition(a)
                    }
                }, r.controller = {
                    LinearSpline: function (a, b) {
                        ...
                        r.controller.spline || (r.controller.spline = r.params.loop ? new r.controller.LinearSpline(r.slidesGrid, a.slidesGrid) : new r.controller.LinearSpline(r.snapGrid, a.snapGrid))
                    }, setTranslate: function (a, b) {
                        function d(b) {
                            a = b.rtl && "horizontal" === b.params.direction ? -r.translate : r.translate, "slide" === r.params.controlBy && (r.controller.getInterpolateFunction(b), f = -r.controller.spline.interpolate(-a)), f && "container" !== r.params.controlBy || (e = (b.maxTranslate() - b.minTranslate()) / (r.maxTranslate() - r.minTranslate()), f = (a - r.minTranslate()) * e + b.minTranslate()), r.params.controlInverse && (f = b.maxTranslate() - f), b.updateProgress(f), b.setWrapperTranslate(f, !1, r), b.updateActiveIndex()
                        }

                        var e, f, g = r.params.control;
                        if (r.isArray(g))for (var h = 0; h < g.length; h++)g[h] !== b && g[h] instanceof c && d(g[h]); else g instanceof c && b !== g && d(g)
                    }, setTransition: function (a, b) {
                        function d(b) {
                            b.setWrapperTransition(a, r), 0 !== a && (b.onTransitionStart(), b.wrapper.transitionEnd(function () {
                                f && (b.params.loop && "slide" === r.params.controlBy && b.fixLoop(), b.onTransitionEnd())
                            }))
                        }

                        var e, f = r.params.control;
                        if (r.isArray(f))for (e = 0; e < f.length; e++)f[e] !== b && f[e] instanceof c && d(f[e]); else f instanceof c && b !== f && d(f)
                    }
                }, r.hashnav = {
                    init: function () {
                        if (r.params.hashnav) {
                            ...
                            if (a)for (var b = 0, c = 0, d = r.slides.length; d > c; c++) {
                                var e = r.slides.eq(c), f = e.attr("data-hash");
                                if (f === a && !e.hasClass(r.params.slideDuplicateClass)) {
                                    var g = e.index();
                                    r.slideTo(g, b, r.params.runCallbacksOnInit, !0)
                                }
                            }
                        }
                    }, setHash: function () {
                        r.hashnav.initialized && r.params.hashnav && (document.location.hash = r.slides.eq(r.activeIndex).attr("data-hash") || "")
                    }
                ...
                try {
                    new window.WheelEvent("wheel"), r.mousewheel.event = "wheel"
                } catch (H) {
                }
                r.mousewheel.event || void 0 === document.onmousewheel || (r.mousewheel.event = "mousewheel"), r.mousewheel.event || (r.mousewheel.event = "DOMMouseScroll")
            }
            r.disableMousewheelControl = function () {
                return r.mousewheel.event ? (r.container.off(r.mousewheel.event, k), !0) : !1
            }, r.enableMousewheelControl = function () {
                return r.mousewheel.event ? (r.container.on(r.mousewheel.event, k), !0) : !1
            }, r.parallax = {
                setTranslate: function () {
                    ...
                    "undefined" == typeof a && (a = r.params.speed), r.container.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function () {
                        var c = b(this), d = parseInt(c.attr("data-swiper-parallax-duration"), 10) || a;
                        0 === a && (d = 0), c.transition(d)
                    })
                }
            }, r._plugins = [];
            for (var I in r.plugins) {
                var J = r.plugins[I](r, r.params[I]);
                J && r._plugins.push(J)
            }
            return r.callPlugins = function (a) {
                for (var b = 0; b < r._plugins.length; b++)a in r._plugins[b] && r._plugins[b][a](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
            }, r.emitterEventListeners = {}, r.emit = function (a) {
                r.params[a] && r.params[a](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                var b;
                if (r.emitterEventListeners[a])for (b = 0; b < r.emitterEventListeners[a].length; b++)r.emitterEventListeners[a][b](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                r.callPlugins && r.callPlugins(a, arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
            }, r.on = function (a, b) {
                return a = m(a), r.emitterEventListeners[a] || (r.emitterEventListeners[a] = []), r.emitterEventListeners[a].push(b), r
            }, r.off = function (a, b) {
                var c;
                if (a = m(a), "undefined" == typeof b)return r.emitterEventListeners[a] = [], r;
                if (r.emitterEventListeners[a] && 0 !== r.emitterEventListeners[a].length) {
                    for (c = 0; c < r.emitterEventListeners[a].length; c++)r.emitterEventListeners[a][c] === b && r.emitterEventListeners[a].splice(c, 1);
                    return r
                }
            }, r.once = function (a, b) {
                a = m(a);
                var c = function () {
                    b(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4]), r.off(a, c)
                };
                return r.on(a, c), r
            }, r.a11y = {
                ...
                onEnterKey: function (a) {
                    13 === a.keyCode && (b(a.target).is(r.params.nextButton) ? (r.onClickNext(a), r.isEnd ? r.a11y.notify(r.params.lastSlideMessage) : r.a11y.notify(r.params.nextSlideMessage)) : b(a.target).is(r.params.prevButton) && (r.onClickPrev(a), r.isBeginning ? r.a11y.notify(r.params.firstSlideMessage) : r.a11y.notify(r.params.prevSlideMessage)), b(a.target).is("." + r.params.bulletClass) && b(a.target)[0].click())
                },
                liveRegion: b('<span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>'),
                notify: function (a) {
                    var b = r.a11y.liveRegion;
                    0 !== b.length && (b.html(""), b.html(a))
                },
                init: function () {
                    if (r.params.nextButton) {
                        var a = b(r.params.nextButton);
                        r.a11y.makeFocusable(a), r.a11y.addRole(a, "button"), r.a11y.addLabel(a, r.params.nextSlideMessage)
                    }
                    if (r.params.prevButton) {
                        var c = b(r.params.prevButton);
                        r.a11y.makeFocusable(c), r.a11y.addRole(c, "button"), r.a11y.addLabel(c, r.params.prevSlideMessage)
                    }
                    b(r.container).append(r.a11y.liveRegion)
                },
                initPagination: function () {
                    r.params.pagination && r.params.paginationClickable && r.bullets && r.bullets.length && r.bullets.each(function () {
                        var a = b(this);
                        r.a11y.makeFocusable(a), r.a11y.addRole(a, "button"), r.a11y.addLabel(a, r.params.paginationBulletMessage.replace(/{{index}}/, a.index() + 1))
                    })
                },
                destroy: function () {
                ...
                r.container.removeClass(r.classNames.join(" ")).removeAttr("style"), r.wrapper.removeAttr("style"), r.slides && r.slides.length && r.slides.removeClass([r.params.slideVisibleClass, r.params.slideActiveClass, r.params.slideNextClass, r.params.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-column").removeAttr("data-swiper-row"), r.paginationContainer && r.paginationContainer.length && r.paginationContainer.removeClass(r.params.paginationHiddenClass), r.bullets && r.bullets.length && r.bullets.removeClass(r.params.bulletActiveClass), r.params.prevButton && b(r.params.prevButton).removeClass(r.params.buttonDisabledClass), r.params.nextButton && b(r.params.nextButton).removeClass(r.params.buttonDisabledClass), r.params.scrollbar && r.scrollbar && (r.scrollbar.track && r.scrollbar.track.length && r.scrollbar.track.removeAttr("style"),
                r.scrollbar.drag && r.scrollbar.drag.length && r.scrollbar.drag.removeAttr("style"))
            }, r.destroy = function (a, b) {
                r.detachEvents(), r.stopAutoplay(), r.params.scrollbar && r.scrollbar && r.params.scrollbarDraggable && r.scrollbar.disableDraggable(), r.params.loop && r.destroyLoop(), b && r.cleanupStyles(), r.disconnectObservers(), r.params.keyboardControl && r.disableKeyboardControl && r.disableKeyboardControl(), r.params.mousewheelControl && r.disableMousewheelControl && r.disableMousewheelControl(), r.params.a11y && r.a11y && r.a11y.destroy(), r.emit("onDestroy"), a !== !1 && (r = null)
            }, r.init(), r
        }
    };
    c.prototype = {
...
/*    $(function () {
    ...
    $(".tab_item").not(":first").hide(), $(".wrapper .tab").show().click(function () {
    var a = $(this).index();
    $(".wrapper .tab").removeClass("active-done").eq(a).addClass("active-done"), $(".tab_item").hide().eq(a).fadeIn()
}).eq(0).addClass("active-done"), $(".tab_item-test").not(":first").hide(), $(".self-test__wrap .tab-test").show().click(function () {
    var a = $(this).index();
    $(".self-test__wrap .tab-test").removeClass("active-test").eq(a).addClass("active-test"), $(".tab_item-test").hide().eq(a).fadeIn()
}).eq(0).addClass("active-test"), $(".tab_item-qw").not(":first").hide(), $(".wrapper-qw .tab-qw").show().click(function () {
    var a = $(this).index();
    $(".wrapper-qw .tab-qw").removeClass("active-qw").eq(a).addClass("active-qw"), $(".tab_item-qw").hide().eq(a).fadeIn()
}).eq(0).addClass("active-qw"), $("#online").click(function () {
    $("#online").css("display", "none"), $("#offline").css("display", "block")
}), $("#offline").click(function () {
    $("#online").css("display", "block"), $("#offline").css("display", "none")
}), $("[id*=leave-reviews]").click(function (a) {
    a.preventDefault(), a.stopPropagation(), $("#pop-up").show()
}), $("[class*=pop-up]").click(function (a) {
    a.stopPropagation()
}), $("html").click(function () {
    $("#pop-up").hide()
    ...
    $(".header-main_menu").animate({opacity: "toggle", height: "toggle"}, 1e3)
}),$(".js-panel__click").click(function () {
    $("#js-panel__user-option").animate({opacity: "toggle", height: "toggle"}, 200)
}),$(document).click(function (a) {
    $(a.target).closest(".panel__user-menu").length || $("#js-panel__user-option").hide(), a.stopPropagation()
}),
/*$(function () {
    autoWidth()
}),$(window).resize(function () {
...
$(document).ready(function () {
    $(".harmonica-menu-js a").click(function () {
        $(this).next(".harmonica-menu-js-hidden").slideToggle(), $(this).next(".harmonica-menu-js-item").slideToggle(), $(this).toggleClass("harmonica-menu-js-close")
    })
}),$(function () {
    ...
    a("#user_phone").mask("(999) 999-99-99")
}),$(".more").click(function () {
    $(".hide_overflow").is(":visible") ? ($(".hide_overflow").addClass("show_overflow").removeClass("hide_overflow"), $(".click-more").html("Скрыть")) : ($(".show_overflow").removeClass("show_overflow").addClass("hide_overflow"), $(".click-more").html("Подробнее"))
}),$(".more-bottom").click(function () {
    $(".hide_overflow-bottom").is(":visible") ? ($(".hide_overflow-bottom").addClass("show_overflow-bottom").removeClass("hide_overflow-bottom"), $(".click-more-bottom").html("Скрыть")) : ($(".show_overflow-bottom").removeClass("show_overflow-bottom").addClass("hide_overflow-bottom"), $(".click-more-bottom").html("Подробнее"))
}),$(function () {
    $(".clinic-time__number--main-clinic").click(function () {
        $(this).siblings(".clinic-time__tel--main-clinic").css("display", "block"), $(this).hide()
    })
}),$(function () {
    $(".clicktext").toggle(function () {
        $(this).siblings(".article-text-hide").addClass("article-text-show").removeClass("article-text-hide"), $(this).hide()
    }, function () {
        $(this).siblings(".article-text-show").removeClass("article-text-show").addClass("article-text-hide"), $(this).show()
    })
}),$(function () {
    $(".rev").on("click", ".open", function () {
        var a = $(this).siblings(".sub");
        $(this).text(a.is(":visible") ? "Подробнее" : "Скрыть"), a.toggleClass("hide")
    })
}),$(function () {
    $(".left-side").on("click", ".record-btn", function () {
        var a = $(this).siblings(".record-form");
        a.toggleClass("hide"), $(this).toggleClass("hide")
    })
}),$(function () {
    $(".left-side").on("click", ".answer-doc-btn", function () {
        var a = $(this).siblings(".answer-doc__wrap");
        a.toggleClass("hide"), $(this).toggleClass("hide")
    })
}),$(function () {
    $(".reviews__text").on("click", ".open-review-js", function () {
        var a = $(this).siblings(".sub");
        a.toggleClass("hide-review-js"), $(this).toggleClass("hide")
    })
}),$(".textQW").keyup(function () {
    $(this).height(24), $(this).height(this.scrollHeight)
}),$(".textNote").keyup(function () {
    $(this).height(50), $(this).height(this.scrollHeight)
}),Share = {
    vkontakte: function (a, b, c, d) {
        url = "http://vkontakte.ru/share.php?", url += "url=" + encodeURIComponent(a), url += "&title=" + encodeURIComponent(b), url += "&noparse=true", Share.popup(url)
    }, odnoklassniki: function (a, b, c, d) {
        url = "http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1", url += "&st.comments=" + encodeURIComponent(d), url += "&st._surl=" + encodeURIComponent(a), Share.popup(url)
    }, facebook: function (a, b, c, d) {
        url = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(location.href), Share.popup(url)
    ...
    }, google: function (a, b, c, d) {
        url = "https://plus.google.com/share?", url += "url=" + encodeURIComponent(a), url += "&title=" + encodeURIComponent(b), url += "&description=" + encodeURIComponent(d), url += "&imageurl=" + encodeURIComponent(c), Share.popup(url)
    }, livejornal: function (a, b, c, d) {
        url = "http://www.livejournal.com/update.bml?", url += "subject=" + encodeURIComponent(a) + encodeURIComponent(b), url += "&event=" + encodeURIComponent(d), Share.popup(url)
    }, popup: function (a) {
        window.open(a, "", "toolbar=0,status=0,width=626,height=436")
    }
},function () {
    jQuery("#spterm").on("input", function () {
        if (jQuery("#spterm").val() != a) {
            var a = jQuery("#spterm").val();
            /^[а-яА-ЯёЁ]*$/i.test(a) ? jQuery(document).ready(function () {
                function a() {
                    d = jQuery("#spterm").val(), jQuery("span.highlight").each(function () {
                        jQuery(this).after(jQuery(this).html()).remove()
                    }), jQuery("div#content").find(jQuery("p")).each(function () {
                        jQuery(this).removeClass("word-none")
                    }), jQuery("div#content").find(jQuery("li")).each(function () {
                        jQuery(this).removeClass("word-none")
                    });
                    jQuery("div#content").each(function () {
                        jQuery(this).html(jQuery(this).html().replace(new RegExp(d, "ig"), '<span class="highlight">$&</span>')), jQuery(this).find(jQuery("p:not(:has(span))")).addClass("word-none"), jQuery(this).find(jQuery("li:not(:has(p span))")).addClass("word-none"), e = jQuery("span.highlight").length, 0 == e && jQuery("#spresult").html("Ничего не найдено")
                    })
                }

                var b = 1, c = 500, d = "", e = 0, f = 0, g = 0;
                jQuery("#spterm").keyup(function () {
                    var e = new Date;
                    f = e.getTime(), jQuery("#spterm").val() != d && (jQuery("#spterm").val().length >= b ? setTimeout(function () {
                        var b = new Date;
                        g = b.getTime(), g - f >= c && a()
                    }, c) : (jQuery("#spresult").html("&nbsp"), jQuery("span.highlight").each(function () {
                        jQuery(this).after(jQuery(this).html()).remove()
                    }), jQuery("div#content").find(jQuery("p")).each(function () {
                        jQuery(this).removeClass("word-none")
                    }), jQuery("div#content").find(jQuery("li")).each(function () {
    ...
    jQuery("#spterm-s").on("input", function () {
        if (jQuery("#spterm-s").val() != a) {
            var a = jQuery("#spterm-s").val();
            console.log(a), /^[а-яА-ЯёЁ]*$/i.test(a) ? jQuery(document).ready(function () {
                function a() {
                    d = jQuery("#spterm-s").val(), jQuery("span.highlight").each(function () {
                        jQuery(this).after(jQuery(this).html()).remove()
                    }), jQuery("div#content-s").find(jQuery("div.kliniki-diagn-raspred__td")).each(function () {
                        jQuery(this).removeClass("word-none")
                    }), jQuery("div#content-s").find(jQuery("li")).each(function () {
                        jQuery(this).removeClass("word-none")
                    });
                    jQuery("div#content-s").each(function () {
                        jQuery(this).html(jQuery(this).html().replace(new RegExp(d, "ig"), '<span class="highlight">$&</span>')), jQuery(this).find(jQuery("div.kliniki-diagn-raspred__td:not(:has(ul li a span))")).addClass("word-none"), jQuery(this).find(jQuery("li:not(:has(a span))")).addClass("word-none"), e = jQuery("span.highlight").length, 0 == e && jQuery("#spresult-s").html("Ничего не найдено")
                    })
                }
                ...
                jQuery("#spterm-s").keyup(function () {
                    var e = new Date;
                    f = e.getTime(), jQuery("#spterm-s").val() != d && (jQuery("#spterm-s").val().length >= b ? setTimeout(function () {
                        var b = new Date;
                        g = b.getTime(), g - f >= c && a()
                    }, c) : (jQuery("#spresult-s").html("&nbsp"), jQuery("span.highlight").each(function () {
                        jQuery(this).after(jQuery(this).html()).remove()
                    }), jQuery("div#content-s").find(jQuery("div.kliniki-diagn-raspred__td")).each(function () {
                        jQuery(this).removeClass("word-none")
                    }), jQuery("div#content-s").find(jQuery("li")).each(function () {
    ...
    $("#send-inner").click(function () {
        var a = ($("#author-inner").val(), $("#message-inner").val(), $("#name-comm").val(), $("#date-comm").val(), $("form#form-inner").attr("action"), $("form#form-inner").serialize());
        $("form#form-inner");
        return $.ajax({
            ...
            cache: !1,
            success: function (a) {
                $(".answer__enter--inner").css("display", "none"), $(".answer__item ul li").find("div.ansJs").addClass("answer__comm-wrap"), $(".answer__item ul li").find("div.ansJs").append(a).removeClass("ansJs"), $("textarea").val("")
            }
        }), !1
    })
}),$(function () {
    ...
    $("body").on("click", ".answer__item-btn--mail", function () {
        ...
        if (b(a) === !1) {
            $(".answer__comm-wrap");
            $(this).parents(".answer__item-btn").after($(".answer__enter--inner").css("display", "block")), $(this).parents(".answer__item-text-wrap").after($('<div class="second-level ansJs"></div>')), $(this).parents(".answer__comm-wrap").after($('<div class="second-level ansJs"></div>'))
        } else b(a) === !0 && ($(".answer__enter--inner").css("display", "none"), $(".ansJs").remove())
    })
}),$("body").on("click", ".like", function (a) {
    var b = $(this).data("id"), c = $(this).data("type"), d = $(this);
    console.log(d), $.ajax({
        type: "POST", url: "", data: {id: b, type: c}, success: function (a) {
            "" != $(d).find(".answer__item-btn--like .like_count").html() ? ($(d).find(".answer__item-btn--like .like_count").html(parseInt($(d).parent().find(".answer__item-btn--like .like_count").html()) + 1), console.log(parseInt($(d)))) : $(d).find(".answer__item-btn--like .like_count").html("1")
        }
    })
}),$(".js-more-text").on("click", function () {
    $(this).parents("div.cell").find(".js-lechenie").css("height", "100%"), $(this).parents("p.more-text").remove()
}),$(".js-open-info").on("click", function () {
    $(this).siblings("div.js-hide-info").css("display", "block")
}),$(document).ready(function () {
    $("body").on("click", ".plus", function (a) {
        var b = $(this).data("id"), c = $(this).data("type"), d = $(this).parent().parent();
        $.ajax({
            type: "POST", url: "/algo/add_like.php", data: {id: b, type: c}, success: function (a) {
                "" != $(d).parent().find(".legend-down .plus .like_count").html() ? ($(d).parent().find(".legend-down .plus  .like_count").html(parseInt($(d).parent().find(".legend-down .plus  .like_count").html()) + 1), console.log(".like_count"), console.log(d)) : $(d).parent().find(".legend-down .plus  .like_count").html("1")
            }
        })
    }), $("body").on("click", ".minus", function (a) {
        var b = $(this).data("id"), c = $(this).data("type"), d = $(this).parent().parent();
        $.ajax({
            type: "POST", url: "/algo/add_like.php", data: {id: b, type: c}, success: function (a) {
                "" != $(d).parent().find(".legend-down .minus  .unlike_count").html() ? $(d).parent().find(".legend-down  .minus  .unlike_count").html(parseInt($(d).parent().find(".legend-down  .minus .unlike_count").html()) + 1) : $(d).parent().find(".legend-down  .minus  .unlike_count").html("1")
            }
        })
    })
}),$(document).ready(function () {
    $(".js-regaliya", this).each(function () {
        var a = $(this).height();
        a > 80 && ($(this).after('<p class="more-text bg-grey"><span class="js-more-text">Подробнее</span></p>'), $(this).addClass("js-regaliya-heght"), $("p.more-text").on("click", function (a) {
